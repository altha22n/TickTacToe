...
public class TTTController 
{
		...
		try 
		{
			...
			while ( !line.toLowerCase().equals( "quit" )  ) {
				...
				if (line.toLowerCase().equals( "help" ))
				{
					...
					//call the method from the TTTView class
					TTTView.helpInstructions();
				}
				else 
				{
	...
	private void playRound(int loc)
	{
		...
		{
			//print a message and reset the game
			System.out.println( game.getCurrentPlayer() + " " + "won! Great job!");
			game = new TTTModel();
